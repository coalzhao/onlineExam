...
public class CmsUtils {
    ...
    private static SubjectService subjectService = SpringContextHolder.getBean(SubjectService.class);
	 ...
	 * @author SunJiaMing
	 */
	public static void subjectSort(String paperId) {
		List<String> subList=paperService.getSubjectIds(paperId);
		if(subList!=null) {
			for (int i = 0; i < subList.size(); i++) {
				System.out.println("========="+subList.get(i));
				paperService.subjectSort(paperId, subList.get(i), i+1);
			}
		}
	}
