...
<h2>
	...
	<span style="float:right;">结果:<c:if test="${subject.result.equals('T')}">正确</span></c:if>
	<span style="float:right;"><c:if test="${subject.result.equals('F')}">错误</span></c:if>
	</h2>
	
	<li data-role="list-divider"><c:out value='${idsubject.index+1}'/>.${subject.title}</li>
