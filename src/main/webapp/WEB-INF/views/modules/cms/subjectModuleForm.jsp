...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cms/subjectRoot/moduleForm?id=${subjectRoot.id}&parent.id=${subjectRoot.parent.id}">模块<shiro:hasPermission name="cms:subjectRoot:edit">${not empty subjectRoot.id?'修改':'添加'}</shiro:hasPermission></a></li>
		<li><a href="${ctx}/cms/subjectRoot/form">题根添加</a></li>
	</ul><br/>
...
<!-- 		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input name="parent.id" type="hidden" value="${subjectModule.id}"/>
			<input type="text" disabled="disabled" value="${subjectModule.name}"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">模块名称:</label>
			<div class="controls">
				<form:input id="moduleName" path="name" htmlEscape="false" maxlength="50" class="required"/>
			</div>
		</div>
 		<div class="control-group">
