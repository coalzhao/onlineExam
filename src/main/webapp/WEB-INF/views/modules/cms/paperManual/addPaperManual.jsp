...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/paper/manual/goManual">手动组卷</a></li>
		<li><a href="${ctx}/cms/paper/manual/selectListPaper">试卷列表</a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="paper"
		...
		<div id="div1" class="control-group">
			...
			<div class="controls">
				<form:input id="input1" path="paperName" onblur="aaa()" htmlEscape="false"
