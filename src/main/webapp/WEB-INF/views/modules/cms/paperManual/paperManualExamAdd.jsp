...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/paper/manual/goManualExam">手动组卷</a></li>
		<li><a href="${ctx}/cms/paper/manual/selectListPaperExam">试卷列表</a></li>
	</ul>
			...
			<div style="float: left;">
				...
				<div class="controls">
					<!-- <input type=radio name="simulate"  checked="checked" value="0">考试 -->
					 <input type=radio name="simulate" value="0" checked="checked">考试
				</div>
			</div>
		</div>
