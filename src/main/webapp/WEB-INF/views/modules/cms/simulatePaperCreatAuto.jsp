			...
			if(treeNode.isParent) {
				$.each(treeNode.children, function(index, value) {
					if(treeNode.checked) {
						$.ajax({
							type:"GET",
							url:"${ctx}/cms/paper/getSimuNumber",
							data:"id="+value.id,
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="<c:url value='${fns:getAdminPath()}/cms/paper/simuform'></c:url>">自动组卷</a></li>
	...
	<form:form id="inputForm" modelAttribute="paper"
		...
		<input type="hidden" value="1" name="simulate"/>
		...
		<div id="div1" class="control-group">
			...
			<div class="controls">
				<form:input id="input1"  onblur="aaa()" path="paperName" htmlEscape="false" maxlength="200"
